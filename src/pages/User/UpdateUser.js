                ...
                <div className={cx('container')}>
                    <div className={cx('content')}>
                        ...
                        <div className={cx('info-group')}>
                            ...
                            <input type="password" name="passWord" value={user.passWord} onChange={handleChange} className={cx('input')} required />
                        </div>
                        <div className={cx('info-group')}>
                        ...
                        <div className={cx('info-group')}>
                            ...
                            <input type="text" name="phoneNumber" value={user.phoneNumber} onChange={handleChange} className={cx('input')} required />
                        </div>
                        <div className={cx('info-group')}>
